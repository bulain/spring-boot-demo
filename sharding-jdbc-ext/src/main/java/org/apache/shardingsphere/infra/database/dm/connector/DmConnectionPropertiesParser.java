...
package org.apache.shardingsphere.infra.database.dm.connector;
...
public final class DmConnectionPropertiesParser implements ConnectionPropertiesParser {
    ...
    public ConnectionProperties parse(final String url, final String username, final String catalog) {
        ...
        return new StandardConnectionProperties(jdbcUrl.getHostname(), jdbcUrl.getPort(DEFAULT_PORT), jdbcUrl.getDatabase(), (String)null, jdbcUrl.getQueryProperties(), new Properties());
    }
